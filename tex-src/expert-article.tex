...
\bibitem{daq} Andre~J~M {\it et al.}, {\it Performance of the new DAQ system of the CMS experiment for run-2}
\bibitem{cms} CMS Collaboration, {\it The CMS experiment at the CERN LHC} JINST 3 S08004 (2008)
\end{thebibliography}
